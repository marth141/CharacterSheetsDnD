...
displayNumberIndex = {
    ...
    InitiativeDisplayIdx = 93,
    VisionDisplayIdx = 94,
    SpeedDisplayIdx = 95,
    HitDiceClass1DisplayIdx = 96,
    HitDiceClass2DisplayIdx = 97,
    HitDiceClass1TotalDisplayIdx = 98,
    HitDiceClass2TotalDisplayIdx = 99,
    SpellSaveDC1DisplayIdx = 100,
    SpellAtkBonus1DisplayIdx = 101,
    SpellSaveDC2DisplayIdx = 102,
    SpellAtkBonus2DisplayIdx = 103,
}
